...
(def isco-level-4 "isco-level-4")
(def isco-level-1 "isco-level-1")
(def keyword "keyword")
...
(def sun-education-field-1 "sun-education-field-1")
(def sun-education-field-2 "sun-education-field-2")
(def sun-education-field-3 "sun-education-field-3")
(def sun-education-field-4 "sun-education-field-4")
(def sun-education-level-1 "sun-education-level-1")
(def sun-education-level-2 "sun-education-level-2")
(def sun-education-level-3 "sun-education-level-3")
(def unemployment-funds "unemployment-funds")
...
(def related "related")
(def substitutability "substitutability")

(s/def ::relation-types #{broader narrower substitutability related})
